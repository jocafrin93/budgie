    ...
    return (
        <div>
            ...
            <div className="space-y-4">
                {Object.values(categorizedExpenses).map(category => (
                    <div
                        key={category.id}
                    ...
                    >
                        <div className="p-4 relative">
                            ...
                            <div className="flex items-center justify-between mb-3">
                                <div
                                    className="flex items-center cursor-pointer flex-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded px-2 py-1 transition-colors"                                    onClick={() => {
                                        setCategories(prev =>
                                            prev.map(cat =>
                                                cat.id === category.id
                                ...
                                {category.expenses.length === 0 && category.goals.length === 0 ? (
                                    ...
                                    <div className="space-y-2">
                                        {category.expenses.map(expense => (
                                            ...
                                            >
                                                <div
                                                    className="p-3 cursor-pointer transition-colors hover:bg-gray-100 dark:hover:bg-gray-700"                                                    onClick={() => {
                                                        setExpenses(prev =>
                                                            prev.map(exp =>
                                                                exp.id === expense.id
