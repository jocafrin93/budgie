              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 border-t border-b text-xs ${
                      outflowAmount > 0
                  ...
                  <button
                    ...
                    className={`px-3 py-2 border-t border-r border-b rounded-r text-xs ${
                      inflowAmount > 0
...
const TransactionRow = ({
            ...
            <div className="text-right">
              <div
                className={`text-lg font-semibold ${
                  transaction.amount < 0 ? 'text-theme-red' : 'text-theme-green'
                }`}
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div
                    className={`text-sm font-medium ${
                      split.amount < 0 ? 'text-theme-red' : 'text-theme-green'
                    }`}
                  >
                    {split.amount < 0 ? '-' : '+'}$
  ...
  const DesktopTableRow = () => {
    return (
      <>
        <tr
          className={`transition-colors hover:table-row-hover ${
            index % 2 === 0 ? 'table-row-even' : 'table-row-odd'
          } ${isSelected ? 'bg-theme-active' : ''} ${
            isSplitTransaction ? 'cursor-pointer' : ''
          }`}
...
const TransactionsTab = ({
  ...
  const formatTransferPayee = (transaction) => {
    ...
    return `Transfer: ${fromAccount?.name || 'Unknown'} → ${
