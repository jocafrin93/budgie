...
export function Notifications() {
  ...
  return (
    <Popover className="relative flex">
      ...
      >
        <AlarmIcon className="size-6 text-base-content" />
      ...
      >
        <PopoverPanel
          ...
          className="z-70 mx-4 flex h-[min(32rem,calc(100vh-6rem))] w-[calc(100vw-2rem)] flex-col rounded-lg border border-base-200 bg-base-100 shadow-soft bg-base-100 sm:m-0 sm:w-80"
        >
          {({ close }) => (
            <div className="flex grow flex-col overflow-hidden">
              <div className="rounded-t-lg bg-base-200">
                <div className="flex items-center justify-between px-4 pt-2">
                  <div className="flex items-center gap-2">
                    <h3 className="font-medium text-base-content text-base-content">
                      Notifications
                    </h3>
                    {notifications.length > 0 && (
                      <Badge
              ...
              >
                <TabList className="hide-scrollbar flex shrink-0 overflow-x-auto scroll-smooth bg-base-200 px-3 bg-base-100">
                  <Tab
                    onFocus={(e) => {
                    ...
                    className={({ selected }) =>
                      clsx(
                        ...
                        selected
                          ...
                          : "border-transparent hover:bg-base-200 focus:bg-base-200",
                      )
                    }
                    as={Button}
                    unstyled
              ...
              {((notifications.length > 0 && activeTab === 0) ||
                filteredNotifications.length > 0) && (
                  <div className="shrink-0 overflow-hidden rounded-b-lg bg-base-200">
                    <Button
                      // variant="flat"
    ...
    <div className="group flex items-center justify-between gap-3">
      <div className="flex min-w-0 gap-3">
        ...
        <div className="min-w-0">
          <p className="-mt-0.5 truncate font-medium text-base-content text-base-content">
            {data.title}
          </p>
