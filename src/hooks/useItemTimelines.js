  ...
  return useMemo(() => {
    ...
    effectiveExpenses.forEach(expense => {
      try {
        ...
        const relevantPaychecks = getRelevantPaychecksForItem(account.id, expense.dueDate);
        ...
        const timeline = calculateFundingTimeline({
          ...
          biweeklyAmount: allocation.biweeklyAmount,
          relevantPaychecks
        });
        ...
        // Generate message
        const message = getTimelineMessage(timeline);
    ...
    effectiveSavingsGoals.forEach(goal => {
      try {
        ...
        const relevantPaychecks = getRelevantPaychecksForItem(account.id, goal.targetDate);
